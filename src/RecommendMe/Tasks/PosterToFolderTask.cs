...
namespace RecommendMe.Tasks
{
    ...
    /// </summary>
    public class RecommendMeTask : IScheduledTask
    {
        private readonly ILibraryManager libraryManager;
        private readonly IFileSystem fileSystem;
        private readonly ILogger logger;

        public RecommendMeTask(ILibraryManager libraryManager, IFileSystem fileSystem, ILogManager logManager)
        {
            this.libraryManager = libraryManager;
            this.fileSystem = fileSystem;
            this.logger = logManager.GetLogger("RecommendMe");
        }

        public string Name => "Copy Posters to Folder Images";

        public string Key => "RecommendMeTask";
